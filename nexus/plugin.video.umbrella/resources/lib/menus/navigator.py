...
class Navigator:
	...
	def root(self):
		...
		if getMenuEnabled('navi.anime'): self.addDirectoryItem('Anime', 'anime_Navigator', 'anime.png', 'DefaultFolder.png')
	...
	def tools(self):
		...
		self.addDirectoryItem(40162, 'tools_openSettings&query=6.0', 'sorting-and-filtering.png', 'DefaultAddonService.png', isFolder=False)
		#-- Accounts - 7
		self.addDirectoryItem(32044, 'tools_openSettings&query=10.0', 'my-accounts-settings.png', 'DefaultAddonService.png', isFolder=False)
		self.addDirectoryItem(40124, 'tools_openSettings&query=12.0', 'meta-accounts.png', 'DefaultAddonService.png', isFolder=False)
		self.addDirectoryItem(40123, 'tools_openSettings&query=8.0', 'trakt.png', 'DefaultAddonService.png', isFolder=False)
		...
		#-- Navigation - 1
		self.addDirectoryItem(32362, 'tools_openSettings&query=1.0', 'navigation.png', 'DefaultAddonService.png', isFolder=False)
		#-- Playback - 3
		self.addDirectoryItem(32045, 'tools_openSettings&query=5.0', 'playback.png', 'DefaultAddonService.png', isFolder=False)
		#-- Downloads - 10
		self.addDirectoryItem(32048, 'tools_openSettings&query=14.0', 'downloads.png', 'DefaultAddonService.png', isFolder=False)
		#-- Subtitles - 11
		self.addDirectoryItem(32046, 'tools_openSettings&query=15.0', 'subtitles.png', 'DefaultAddonService.png', isFolder=False)
	...
	def library(self): # -- Library - 9
		self.addDirectoryItem(32557, 'tools_openSettings&query=13.0', 'settings.png', 'DefaultAddonProgram.png', isFolder=False)
